...
import { FaChalkboardTeacher, FaCalculator, FaBook, FaMapMarkedAlt, FaThumbtack } from "react-icons/fa";
      ...
      {pinned.length > 0 && (
        <div className="flex flex-col items-center gap-8 mb-8">
          {pinned.map(({ title, desc, icon, link, badge }) => (
            <Link href={link} key={title} className="max-w-md w-full h-full">
